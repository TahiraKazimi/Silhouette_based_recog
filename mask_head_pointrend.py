...
from detectron2.projects.point_rend.point_head import build_point_head, roi_mask_point_loss
...
class PointRendMaskHeadModified(nn.Module):
    ...
    def forward(self, features, instances):
        ...
        """
        if self.training:
          #print("forward call from mask head in pointrend")
...
@ROI_MASK_HEAD_REGISTRY.register()
class ImplicitPointRendMaskHeadModified(PointRendMaskHeadModified):
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
